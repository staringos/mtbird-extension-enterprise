...
const activity = (context: IExtensionContext) => {
  ...
  context.registerFeature(
    "enterprise.struct-tree.feature",
    ExtensionStructureTree
  );
  context.registerFeature("enterprise.template-panel.feature", TemplatePanel);
  context.registerFeature(
    "enterprise.block-container-panel.feature",
    ExtensionBlockContainerPanel
  );
  ...
  context.registerFeature(
    "enterprise.component-libs-panel.feature",
    ComponentLibsPanel
  );
};
