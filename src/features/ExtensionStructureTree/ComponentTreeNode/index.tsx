...
export const ComponentTreeNode: React.FC<IProps> = ({
  ...
  const nodeData: ComponentDataNode = {
    ...
    isLeaf,
    switcherIcon: isLeaf ? (
      <i className="mtbird-icon mtbird-minus-square" />
    ) : undefined,
  };
  return (
    <TreeNode
...
function getTitleText(
  ...
  let componentName =
    ...
    context.registeredComponents[component.componentName] &&
    context.registeredComponents[component.componentName].title;
