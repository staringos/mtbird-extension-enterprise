...
export const HistoryItem: React.FC<IProps> = ({itemData, onRollback, isFirstItem}) => {
    return (
        <div className={styles.historyItem}>
            <div className={styles.timeline}>
                <span className={$(styles.beforeTimeline, {[styles.beforeTimelineFirstItem]: isFirstItem})}/>
                {isFirstItem &&
                    <div className={styles.firstItemDot}>
                        <svg className="icon" viewBox="0 0 1053 1024" version="1.1"
                             width="64" height="64">
                            <path
            ...
            <div className={styles.historyItemContent}>
                ...
                <div className={styles.timeAndAction}>
                    ...
                    <span className={styles.rollback} onClick={() => onRollback(itemData)}>恢复</span>
                </div>
            </div>
        </div>
    )
